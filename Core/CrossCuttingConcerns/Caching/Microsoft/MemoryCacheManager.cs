...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    public class MemoryCacheManager : ICacheManager
    {
        ...
        {
            return _memoryCache.Get<T>(key); //bu burada boxing yapılmış.
        }

        public object Get(string key)
        {
            return _memoryCache.Get(key); //bunu kullanırken boxing yapmak gerekir.
        }

        public bool IsAdd(string key)
        {
            return _memoryCache.TryGetValue(key,out _); // datayı out etmesini istemiyorsak bu kullanılabilir.
        }
